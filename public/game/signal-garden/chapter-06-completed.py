#!/usr/bin/env python3
"""Signal Garden — Chapter 6: Player object and saves

Run interactively:
    python chapter-06-completed.py

Run the deterministic verification demo:
    python chapter-06-completed.py --demo
"""
...
def run_demo():
    ...
    print(f"SIGNAL GARDEN / CHAPTER {CHAPTER} / PLAYER OBJECT AND SAVES")
...
def chapter_task():
    """Package state in a class and save progress as JSON."""
    return "Player object and saves complete"
