#!/usr/bin/env python3
"""Signal Garden — Chapter 3: Command rules

Run interactively:
    python chapter-03-completed.py

Run the deterministic verification demo:
    python chapter-03-completed.py --demo
"""
...
def run_demo():
    ...
    print(f"SIGNAL GARDEN / CHAPTER {CHAPTER} / COMMAND RULES")
...
def chapter_task():
    """Validate movement and branch on commands."""
    return "Command rules complete"
