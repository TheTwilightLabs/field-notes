#!/usr/bin/env python3
"""Signal Garden — Chapter 5: Action functions

Run interactively:
    python chapter-05-completed.py

Run the deterministic verification demo:
    python chapter-05-completed.py --demo
"""
...
def run_demo():
    ...
    print(f"SIGNAL GARDEN / CHAPTER {CHAPTER} / ACTION FUNCTIONS")
...
def chapter_task():
    """Separate movement, listening, resting, and status."""
    return "Action functions complete"
