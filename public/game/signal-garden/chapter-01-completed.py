#!/usr/bin/env python3
"""Signal Garden — Chapter 1: Player state

Run interactively:
    python chapter-01-completed.py

Run the deterministic verification demo:
    python chapter-01-completed.py --demo
"""
...
def run_demo():
    ...
    print(f"SIGNAL GARDEN / CHAPTER {CHAPTER} / PLAYER STATE")
...
def chapter_task():
    """Create player variables and print a status panel."""
    return "Player state complete"
