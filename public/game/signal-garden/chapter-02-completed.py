#!/usr/bin/env python3
"""Signal Garden — Chapter 2: World map

Run interactively:
    python chapter-02-completed.py

Run the deterministic verification demo:
    python chapter-02-completed.py --demo
"""
...
def run_demo():
    ...
    print(f"SIGNAL GARDEN / CHAPTER {CHAPTER} / WORLD MAP")
...
def chapter_task():
    """Represent connected locations with dictionaries and collections."""
    return "World map complete"
