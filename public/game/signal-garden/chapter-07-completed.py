#!/usr/bin/env python3
"""Signal Garden — Chapter 7: Complete game

Run interactively:
    python chapter-07-completed.py

Run the deterministic verification demo:
    python chapter-07-completed.py --demo
"""
...
def run_demo():
    ...
    print(f"SIGNAL GARDEN / CHAPTER {CHAPTER} / COMPLETE GAME")
...
def chapter_task():
    """Combine every system and add your own extension."""
    return "Complete game complete"
